...
import org.jsharkey.oilcan.R;
import org.jsharkey.oilcan.R.drawable;
import org.jsharkey.oilcan.R.layout;
import org.jsharkey.oilcan.R.string;
...
public final class ContactsListActivity extends ListActivity
    ...
    /** Show all email addresses and pick them when clicking */
    static final int MODE_PICK_EMAIL = 56 | MODE_MASK_PICKER | MODE_MASK_NO_PRESENCE | MODE_MASK_NO_FILTER;
    /** Run a search query */
...
//        } else 
        if (Intent.ACTION_GET_CONTENT.equals(action)) {
            ...
            if (People.CONTENT_ITEM_TYPE.equals(type)) {
                ...
                mMode = MODE_PICK_POSTAL;
            } else if (ContactMethods.CONTENT_EMAIL_ITEM_TYPE.equals(type)) {
    ...
    void startQuery() {
        ...
        switch (mMode) {
            ...
            case MODE_PICK_EMAIL:
                mQueryHandler.startQuery(QUERY_TOKEN, null, ContactMethods.CONTENT_URI,
                        CONTACT_METHODS_PROJECTION,
                        ContactMethods.KIND + "=" + Contacts.KIND_EMAIL, null, SORT_ORDER);
                break;
        }
    }
...
//        }
    ...
    private final class ContactItemListAdapter extends ResourceCursorAdapter
        ...
        public ContactItemListAdapter(Context context, int resource, Cursor cursor) {
            ...
            switch (mMode) {
                case MODE_PICK_POSTAL:
                    mLocalizedLabels = EditContactActivity.getLabelsForKind(getBaseContext(),
        ...
        private void getAlphabet(Context context) {
            String alphabetString = "\u0020ABCDEFGHIJKLMNOPQRSTUVWXYZ"; //context.getResources().getString(R.string.alphabet);
