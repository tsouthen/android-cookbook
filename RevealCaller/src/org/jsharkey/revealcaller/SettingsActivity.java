...
public class SettingsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// settings are maybe enable/disable (start/stop service), number of times to keep rotating notif
		// (or is problem solved if we have a thread that simply sleeps and launches new notifs UNTIL its
		// stopped by onStopRinging()?
